			...
			<div class="layui-card daohan">										
			  <div class="layui-card-header"><a href="downloadAction.action?fileid=${file.fileid}">文件标题：${file.filename}</a></div>			  
			   ...
			   <div class="layui-card-body line-limit-length">
			   	...
			   	<span style="margin-left:20px"><a href="downloadAction.action?fileid=${file.fileid}">上传时间:${file.uptime}</a></span>	
			    <span style="margin-left:20px"><a href="downloadAction.action?fileid=${file.fileid}">文件权限:${file.authorityname}</a></span>
			   	<span style="margin-left:20px"><a href="downloadAction.action?fileid=${file.fileid}">所属部门:${file.departmentname}</a></span>	
			    <span style="margin-left:20px"><a href="downloadAction.action?fileid=${file.fileid}">下载次数:${file.downloads}</a></span>	   
			  </div>				 	  			  
